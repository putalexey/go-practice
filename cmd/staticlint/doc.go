/*
Command staticlint checks code for errors it uses go/analysis/passes/*, honnef.co/go/tools/* analyzers
To run test use following command in project root: `./cmd/staticlint/staticlint ./...`

Description of the "go/analysis/passes" analyzers can be found at https://pkg.go.dev/golang.org/x/tools/go/analysis/passes
Used go/analysis/passes analyzers:
	* asmdecl
	* assign
	* atomic
	* atomicalign
...
Used "honnef.co/go/tools" analyzers:
	* staticcheck
